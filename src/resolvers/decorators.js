...
const logInput = fn => (obj, args, context, info) => {
  console.log({
    obj,
    args,
    context,
...
const logResult = fn => async (obj, args, context, info) => {
  try {
...
const timer = (name: String) => fn => async (obj, args, context, info) => {
...
export { use, timer, logInput, logResult };
